  ...
  const I18N = {
    uk: {
      ...
      examples: {
        ...
        goodTitle:"Краще",
        good1:"Привіт! Потрібна допомога: збірка падає на кроці тестів. Пробувала чистити БЗ і перезапускати. Лог: посилання.",
        good2:"Ок — перегляну після прогулки і відпишусь."
      },
      how: {
      ...
      footer: {
        ...
        credit:"Розроблен Suff1XXX. Відкритий код є на GitHub.",
